...
Scanner sc=new Scanner(System.in);
	...
	public static void main(String[] args) {
		...
		obj.print(head);
		head=obj.insert(head, 14,0); // We have to update head. As in insert function we have changed it.
		obj.print(head);
		head=obj.insert(head, 15,3); // We have to update head. As in insert function we have changed it.
		obj.print(head);		
	}
}